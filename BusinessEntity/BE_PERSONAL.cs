...
namespace BusinessEntity
{
    public class BE_PERSONAL
    {
        ...
        private string m_CODIGO_SISPLAN;
        public string CODIGO_SISPLAN
        {
            get { return m_CODIGO_SISPLAN; }
            set { m_CODIGO_SISPLAN = value; }
        }

        private string m_COD_AREA;
        public string COD_AREA
        {
            get { return m_COD_AREA; }
            set { m_COD_AREA = value; }
        }
        ...
        private string m_COD_SUCURSAL;
        public string COD_SUCURSAL
        {
            get { return m_COD_SUCURSAL; }
            set { m_COD_SUCURSAL = value; }
        }
        private string m_DESCRIPCION_SUCURSAL;
        public string DESCRIPCION_SUCURSAL
        {
            get { return m_DESCRIPCION_SUCURSAL; }
            set { m_DESCRIPCION_SUCURSAL = value; }
        }
        ...
        private string m_COD_PERSONAL;
        public string COD_PERSONAL
        {
            get { return m_COD_PERSONAL; }
            set { m_COD_PERSONAL = value; }
        }
        ...
        private string m_FOTOCHECK;
        public string FOTOCHECK
        {
            get { return m_FOTOCHECK; }
            set { m_FOTOCHECK = value; }
        }
        ...
        private string m_EMPRESA_BREVE;
        public string EMPRESA_BREVE
        {
            get { return m_EMPRESA_BREVE; }
            set { m_EMPRESA_BREVE = value; }
        }
    }
}
